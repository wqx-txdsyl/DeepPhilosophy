# -*- coding: utf-8 -*-
"""国富论 ac3189b6656f 按 epub ncx 重建（一次性）
epub: 亚当·斯密/国富论.epub  ncx 71 条（三级）
映射: d0 有子=part（五卷），d0 无子=chapter（总序/编译者语/导读/绪论），d1=chapter，d2=section
      跳过 书名页/版权页/品牌页/正文目录
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/亚当·斯密/国富论.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/ac3189b6656f"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/ac3189b6656f"
SKIP = {"书名页", "版权页", "品牌页", "版权", "目录", "总目录", "封面", "索引"}
...
meta = {
    "bookId": old_meta.get("bookId") or "ac3189b6656f",
    "title": old_meta.get("title") or "国富论",
