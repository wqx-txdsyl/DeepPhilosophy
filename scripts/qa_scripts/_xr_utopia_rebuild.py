# -*- coding: utf-8 -*-
"""乌托邦 86ed11857f43 按 epub ncx 重建（一次性）
epub: 托马斯·莫尔/乌托邦.epub  ncx 27 条（OEBPS/toc.ncx）
映射: d0 有子=part（《乌托邦》第二部/附录二），d0 无子=chapter（版权外前置/第一部）
      d1=chapter（第二部 8 章、附录小节）；跳过 版权
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/托马斯·莫尔/乌托邦.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/86ed11857f43"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/86ed11857f43"
SKIP = {"版权", "版权页", "目录", "封面", "总目录", "《乌托邦》1518年巴塞尔版有边饰的一页"}
