# -*- coding: utf-8 -*-
"""启蒙辩证法 21d51965ccbb 按 epub ncx 重建（一次性）
epub: 霍克海默/启蒙辩证法.epub  ncx 45 条
映射: d0=chapter（启蒙的概念/文化工业/反犹主义要素/笔记与札记/前言/附录），d1=section（附论1-2/笔记条目）；修复 ✗M 三主章缺失
      跳过 版权
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/马克斯·霍克海默/启蒙辩证法.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/21d51965ccbb"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/21d51965ccbb"
SKIP = {"书名页", "版权页", "目录", "封面", "索引", "《启蒙辩证法》详细索引", "作者简介", "译者简介"}
...
meta = {
    "bookId": old_meta.get("bookId") or "21d51965ccbb",
    "title": old_meta.get("title") or "启蒙辩证法",
    "author": old_meta.get("author") or "马克斯·霍克海默、西奥多·阿多诺",
    "toc": toc,
