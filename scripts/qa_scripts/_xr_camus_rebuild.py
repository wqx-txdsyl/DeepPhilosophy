# -*- coding: utf-8 -*-
"""加缪全集（小说卷） 5c77634136c1 按 epub ncx 重建（一次性）
epub: 加缪全集（小说卷）.epub  ncx 25 条
映射: d0 有子=part（局外人/鼠疫/流亡与独立王国/第一个人），d0 无子=chapter（总序/堕落），d1=chapter（第一部/篇名）
      跳过 书名页/版权页/品牌页/正文目录
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/阿尔贝·加缪/加缪全集（小说卷）.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/5c77634136c1"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/5c77634136c1"
SKIP = {"书名页", "版权页", "品牌页", "版权", "目录", "总目录", "封面", "插图"}
...
meta = {
    "bookId": old_meta.get("bookId") or "5c77634136c1",
    "title": old_meta.get("title") or "加缪全集（小说卷）",
