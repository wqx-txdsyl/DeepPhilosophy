# -*- coding: utf-8 -*-
"""内在体验 8383f4e551c4 按 epub ncx 重建（一次性）
epub: 合集&概述/西方哲学史（英汉对照）.epub  ncx 217 条
结构: 内在体验 30 条 ncx（part→序言/三部分+各小节）
映射: depth0 有子=part，无子=独立 chapter；depth1=chapter；depth2+=section
用法: python _xr_weber_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/乔治·巴塔耶/内在体验.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/8383f4e551c4"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/8383f4e551c4"
