# -*- coding: utf-8 -*-
"""人生的智慧 f9549bd811f6 按 epub ncx 重建（一次性）
epub: 叔本华/人生的智慧.epub  ncx 58 条（两级）
映射: d0 有子=part（新版导读/学前课/第1课/第2课/第3课），d0 无子=chapter（附录/作者小传/译者简介），d1=chapter
      跳过 书名页/版权页/品牌页/正文目录
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/阿图尔·叔本华/人生的智慧：如何才能幸福度过一生.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/f9549bd811f6"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/f9549bd811f6"
SKIP = {"书名页", "版权页", "品牌页", "版权信息", "版权", "目录", "总目录", "封面", "索引"}
...
meta = {
    "bookId": old_meta.get("bookId") or "f9549bd811f6",
    "title": old_meta.get("title") or "人生的智慧：如何才能幸福度过一生",
