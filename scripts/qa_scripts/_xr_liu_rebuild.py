# -*- coding: utf-8 -*-
"""刘擎西方现代思想讲义 e95e083c59b5 按 epub ncx 重建（一次性）
epub: 刘擎西方现代思想讲义.epub  ncx 180 条（三级）
映射: d0=chapter（前言/导论/第一章~第X章），d1=section（01~52 讲），d2 并入；修复 ncx 错字（第—章/尼米）
      跳过 版权
用法: python _xr_utopia_rebuild.py [--dry]
"""
import zipfile, re, json, os, sys, html as html_mod, shutil, bisect

EP = 'F:/philosophy/西方/合集&概述/刘擎西方现代思想讲义.epub'
SRC = "f:/program/Python/PhiAgent/backend/data/book_chapters/e95e083c59b5"
DST = "f:/program/Python/DeepPhilosophy/DeepPhilosophy/backend/data/book_chapters/e95e083c59b5"
SKIP = {"版权", "版权页", "目录", "封面", "总目录"}
LABEL_FIX = {"第—章": "第一章", "尼米": "尼采", "由主义及其批判者": "自由主义及其批判者"}
...
meta = {
    "bookId": old_meta.get("bookId") or "e95e083c59b5",
    "title": old_meta.get("title") or "刘擎西方现代思想讲义",
    "author": old_meta.get("author") or "刘擎",
    "toc": toc,
