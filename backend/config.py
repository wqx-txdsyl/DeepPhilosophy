...
# ============================================================
# AI 流式代理（/api/ai/stream）加固（审计 S1）
# ============================================================
# model 白名单: 只允许配置/代码列出的模型, 拒绝客户端任意字符串（防刷余额）
AI_ALLOWED_MODELS = {"deepseek-chat", "deepseek-v4-pro"}
# max_tokens 上限钳制（前端 thinking 模式 4096 / 普通 1024; 客户端超限按此截断）
AI_MAX_TOKENS_CAP = 4096
