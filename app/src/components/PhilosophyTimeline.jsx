...
{ century:'公元前30世纪', name:'萨满哲学', region:'世界', desc:'万物有灵·三层宇宙·灵魂旅程——人类最古老的精神实践。' },
  { century:'公元前30世纪', name:'北极原住民哲学', region:'世界', desc:'冰雪智慧·Sila伦理·动物能动性——极端环境中的生存哲学。' },
  // 公元前15世纪
  { century:'公元前15世纪', name:'印度哲学', region:'世界', desc:'《吠陀》《奥义书》为源头，六派哲学追问解脱。' },
  { century:'公元前15世纪', name:'犹太哲学', region:'世界', desc:'从斐洛到列维纳斯，在雅典与耶路撒冷之间。' },
  { century:'公元前15世纪', name:'南岛哲学', region:'世界', desc:'Mana与Tapu·海洋迁徙·关系性自我——太平洋的哲学智慧。' },
  { century:'公元前15世纪', name:'太平洋原住民哲学', region:'世界', desc:'礼物经济·土地人格·修复性正义——岛屿的生存哲学。' },
  // 公元前10世纪
  { century:'公元前10世纪', name:'波斯哲学', region:'世界', desc:'琐罗亚斯德教善恶二元论——两千五百年的连续传统。' },
  { century:'公元前10世纪', name:'高加索-草原哲学', region:'世界', desc:'游牧伦理·马文化·口头史诗——草原与山麓的智慧。' },
  // 公元前6世纪
  ...
  { century:'1950', name:'人工智能哲学', region:'世界', desc:'人工智能哲学是二十世纪中叶随着计算机科学兴起而诞生的一个哲学分支，它试图回答一个古老而尖锐的问题：机器能否拥有心智？这一' },
  { century:'1763', name:'贝叶斯主义', region:'世界', desc:'贝叶斯主义是一种以概率论为核心工具，将信念、知识与决策纳入严格数学框架的哲学思潮。其源头可追溯至十八世纪英国数学家托马斯' },
  { century:'1057', name:'哲学入词', region:'东方', desc:'哲学入词是中国古典哲学与文学深度融合的一种独特思想流派，其核心在于将深邃的哲学命题、宇宙观、人生论与道德学说，以词这种抒' },
  { century:'19世纪', name:'黑人哲学', region:'世界', desc:'从废奴运动到黑权运动——双重意识、种族批判与黑人存在主义。' },
  { century:'19世纪', name:'高加索哲学', region:'世界', desc:'纳尔特史诗·山地文明·欧亚交汇——山脊上的思想平衡。' },
  // 19世纪末
