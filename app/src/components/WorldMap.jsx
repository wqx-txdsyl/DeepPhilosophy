...
const REGIONS = [
  ...
  { id: 'world', name: '世界传统', sub: '世界哲学', desc: '31大世界哲学传统。', x: 36, y: 50, r: 40, path: '/world-philosophies' },
  ...
  // 中东集群
  { id: 'islam', name: '伊斯兰', sub: '伊斯兰哲学', desc: '百年翻译运动、阿维森纳、苏菲神秘主义。', x: 60, y: 42, r: 24, path: '/school/伊斯兰哲学' },
  { id: 'egypt', name: '古埃及', sub: '古埃及哲学', desc: '玛阿特——宇宙秩序、真理与正义的永恒法则。', x: 52, y: 45, r: 14, path: '/school/古埃及哲学' },
  { id: 'inca', name: '印加', sub: '印加哲学', desc: '帕查、艾尼、帕查玛玛——安第斯的大地伦理。', x: 28, y: 68, r: 14, path: '/school/印加哲学' },
  { id: 'mesopotamia', name: '美索不达米亚', sub: '美索不达米亚哲学', desc: '人类最早的哲学追问。', x: 62, y: 38, r: 14, path: '/school/美索不达米亚哲学' },
  { id: 'persia', name: '波斯', sub: '波斯哲学', desc: '琐罗亚斯德、苏菲诗歌、光明与黑暗。', x: 66, y: 38, r: 18, path: '/school/波斯哲学' },
  { id: 'arab', name: '阿拉伯', sub: '阿拉伯哲学', desc: '理性与信仰的调和。', x: 58, y: 44, r: 16, path: '/school/阿拉伯哲学' },
  { id: 'jewish', name: '犹太', sub: '犹太哲学', desc: '塔木德传统、迈蒙尼德、列维纳斯。', x: 58, y: 40, r: 14, path: '/school/犹太哲学' },
  { id: 'hebrew', name: '希伯来', sub: '古希伯来哲学', desc: '约伯、传道书——信仰、苦难与神圣正义的追问。', x: 56, y: 42, r: 12, path: '/school/古希伯来哲学' },
  { id: 'byzantine', name: '拜占庭', sub: '拜占庭哲学', desc: '东罗马帝国的神学哲学。', x: 55, y: 30, r: 12, path: '/school/拜占庭哲学' },
  // 非洲
  ...
  { id: 'pragmatism', name: '美东', sub: '实用主义', desc: '皮尔士、詹姆斯、杜威——真理即有用。', x: 22, y: 28, r: 12, path: '/school/实用主义' },
