...
const REGIONS = [
  ...
  { id: 'rome', name: '罗马/拜占庭', sub: '罗马·拜占庭哲学', desc: '西塞罗、塞内卡、奥勒留；东罗马神学哲学传统。', x: 50, y: 30, r: 16, path: '/school/罗马哲学' },
  { id: 'slavic', name: '东欧', sub: '东欧斯拉夫哲学', desc: '舍斯托夫、索洛维约夫、俄罗斯宗教哲学。', x: 58, y: 18, r: 20, path: '/school/东欧斯拉夫哲学' },
  // 中东集群
  { id: 'islam', name: '伊斯兰/阿拉伯', sub: '伊斯兰·阿拉伯哲学', desc: '百年翻译运动、阿维森纳、苏菲神秘主义·铿迪、法拉比。', x: 59, y: 43, r: 26, path: '/school/伊斯兰哲学' },
  ...
  { id: 'jewish', name: '犹太/希伯来', sub: '犹太·希伯来哲学', desc: '塔木德、迈蒙尼德、列维纳斯；约伯、传道书。', x: 57, y: 40, r: 16, path: '/school/犹太哲学' },
  // 非洲
  { id: 'africa', name: '非洲', sub: '非洲哲学', desc: '口头传统、社群伦理、后殖民批判。', x: 50, y: 60, r: 40, path: '/school/非洲哲学' },
  // 美洲
  { id: 'na', name: '北美', sub: '北美哲学', desc: '实用主义、超验主义、过程哲学。皮尔士、詹姆斯、杜威。', x: 18, y: 25, r: 32, path: '/school/北美哲学' },
