  ...
  return (
    <div className="page-container" style={{ paddingBottom: 80 }}>
      <section style={{ minHeight: '40vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '72px 32px 48px', position: 'relative', overflow: 'hidden', backgroundImage: 'url(https://deepphilosophy.oss-cn-shanghai.aliyuncs.com/schools/西方哲学.webp?x-oss-process=image/resize,w_1280)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <h1 style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-serif)', fontSize: 'clamp(2rem,5vw,3rem)', fontWeight: 400, color: 'var(--ink)', letterSpacing: '0.04em', lineHeight: 1.2, margin: '0 0 20px' }}>西方哲学</h1>
        <p style={{ position: 'relative', zIndex: 1, fontFamily: 'var(--font-sans)', fontSize: 'clamp(1rem, 1.5vw, 1.2rem)', fontWeight: 500, color: 'var(--ink)', lineHeight: 1.8, maxWidth: 520, margin: '0 auto', textShadow: '0 0 40px rgba(var(--scrim-rgb), 0.8)' }}>从古希腊到后现代，四十二个流派，<br />理性、存在与语言的跨越两千年的探索。</p>
