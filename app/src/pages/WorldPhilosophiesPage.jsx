...
{ name: '古希腊哲学', color: '#C4956A', desc: '西方哲学的总源——以理性思辨取代神话解释，首次追问万物的本原、存在的本质与善的生活。以柏拉图、亚里士多德、前苏格拉底诸学派为代表。' },
  ...
  { name: '萨满哲学', color: '#5A3A8C', desc: '人类最古老的精神实践——三层宇宙与灵魂旅程。万物有灵、形态转换与击鼓出神，在非寻常意识状态中获取知识与疗愈。西伯利亚至美洲的跨文化智慧。' },
  { name: '北极原住民哲学', color: '#6B8EAD', desc: '冰雪中的生存智慧——因纽特Sila伦理、萨米约伊克吟唱。在极限环境中，动物是能动者而非资源，寒冷不是敌人而是导师。气候变化时代的哲学警示。' },
  { name: '南岛哲学', color: '#3A8B9B', desc: '地球上最伟大的航海者的哲学——Mana与Tapu的辩证、关系性自我与海洋本体论。从马达加斯加到复活节岛，横跨两大洋的智慧网络。' },
  ...
  { name: '贝叶斯主义', color: '#58a0b5', desc: '贝叶斯主义是一种以概率论为核心工具，将信念、知识与决策纳入严格数学框架的哲学思潮。其源头可追溯至十八世纪英国数学家托马斯' },
];
